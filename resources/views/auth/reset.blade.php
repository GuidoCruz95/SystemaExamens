    ...
    <div class="login-box">
        ...
        @if (count($errors) > 0)
            <div class="alert alert-danger">
                <strong>Vaya!</strong> Existen problemas con algunas entradas.<br><br>
                <ul>
        ...
        <div class="login-box-body">
            ...
            <a href="{{ url('/auth/login') }}">Iniciar sesión</a><br>
            <a href="{{ url('/auth/register') }}" class="text-center">Registrar nuevo usuario</a>
